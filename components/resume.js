  ...
  return (
    <div className="resume flex flex-row grid gap-10 grid-cols-1 sm:grid-cols-1 lg:grid-cols-2">
      <div className="basis-1/3 mr-20">
        <h2 className="text-3xl md:text-l"><b>—</b> About </h2>
        <br />
        ...
        <div className="description">
          ...
          <br />
          <p>I am skilled with all listed above. But, I will be the first to admit I am not an expert in any - because there's always something new to learn.</p>
        </div>
      </div>
